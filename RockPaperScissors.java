...
public class RockPaperScissors {
    public static void main(String[] args) {
        ...
        // } else {
        // System.out.println("That wasn't one of the options... Cheating isn't
        // allowed.");
        // }

        // losses++;
        // System.out.println("You lose! Enter y to play again, anything else to
        // exit.");
        // playerMove = scanner.nextLine();
        ...
        // System.out.println(
        // "Thanks for playing, 0 wins, " + losses + " losses. Looks like you could use
        // some practice...");
